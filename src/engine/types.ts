/**
 * Core Blackjack domain types used by the pure engine. All code in the React layer
 * consumes these structures and never mutates them directly outside the engine
 * reducer helpers in engine.ts.
 */
export type Suit = "♠" | "♥" | "♦" | "♣";
export type Rank =
  | "A"
